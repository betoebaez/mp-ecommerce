<?php
    include 'Mpago.php';
    $mpagolib = new Mpago();
    $id_pref = $mpagolib->confPreferencia();
?>
<!DOCTYPE html>
...
<script src="https://sdk.mercadopago.com/js/v2"></script>
        ...
        const mp = new MercadoPago("TEST-96b16e87-31b8-477f-9f0b-71a8db653e96", {
            locale: "es-MX",
        });
        ...
        mp.checkout({
            ...
            render: {
                container: ".pagarahora", // Indica el nombre de la clase donde se mostrará el botón de pago
